...
type Top struct {
	...
	Embed0
	*Embed0a
	*Embed0b `jdb:"e,omitempty"` // treated as named
	Embed0c  `jdb:"-"`           // ignored
	Loop
...
type Embed0 struct {
	...
	Level1e int `jdb:"x"` // annihilated by Embed0a.Level1e
}

type Embed0a struct {
	Level1a int `jdb:"Level1a,omitempty"`
	Level1b int `jdb:"LEVEL1B,omitempty"`
	Level1c int `jdb:"-"`
	Level1d int // annihilated by Embed0's Level1d
	Level1f int `jdb:"x"` // annihilated by Embed0's Level1e
}
...
type Loop struct {
	Loop1 int `jdb:",omitempty"`
	Loop2 int `jdb:",omitempty"`
	*Loop
}
...
var unmarshalTests = []unmarshalTest{
	...
	{in: `{"x": 1}`, ptr: new(tx), err: fmt.Errorf("jdb: unknown field \"x\""), disallowUnknownFields: true},
	...
	{in: `{"Y": 1, "Z": 2}`, ptr: new(T), err: fmt.Errorf("jdb: unknown field \"Z\""), disallowUnknownFields: true},

	{in: `{"alpha": "abc", "alphabet": "xyz"}`, ptr: new(U), out: U{Alphabet: "abc"}},
	{in: `{"alpha": "abc", "alphabet": "xyz"}`, ptr: new(U), err: fmt.Errorf("jdb: unknown field \"alphabet\""), disallowUnknownFields: true},
	{in: `{"alpha": "abc"}`, ptr: new(U), out: U{Alphabet: "abc"}},
	{in: `{"alphabet": "xyz"}`, ptr: new(U), out: U{}},
	{in: `{"alphabet": "xyz"}`, ptr: new(U), err: fmt.Errorf("jdb: unknown field \"alphabet\""), disallowUnknownFields: true},
	...
	},
	{
		in:  `{"X": 1,"Y":2}`,
		ptr: new(S5),
		err: fmt.Errorf("jdb: unknown field \"X\""),
	...
	{in: `{"B": "maybe"}`, ptr: new(B), err: errors.New(`jdb: invalid use of ,string struct tag, trying to unmarshal "maybe" into bool`)},
	{in: `{"B": "tru"}`, ptr: new(B), err: errors.New(`jdb: invalid use of ,string struct tag, trying to unmarshal "tru" into bool`)},
	{in: `{"B": "False"}`, ptr: new(B), err: errors.New(`jdb: invalid use of ,string struct tag, trying to unmarshal "False" into bool`)},
	{in: `{"B": "null"}`, ptr: new(B), out: B{false}},
	{in: `{"B": "nul"}`, ptr: new(B), err: errors.New(`jdb: invalid use of ,string struct tag, trying to unmarshal "nul" into bool`)},
	...
	// additional tests for disallowUnknownFields
	{
		...
		ptr: new(Top),
		err: fmt.Errorf("jdb: unknown field \"extra\""),
		disallowUnknownFields: true,
	},
	{
		in: `{
...
type WrongString struct {
	Message string `jdb:"result,string"`
}
...
var wrongStringTests = []wrongStringTest{
	{`{"result":"x"}`, `jdb: invalid use of ,string struct tag, trying to unmarshal "x" into string`},
	{`{"result":"foo"}`, `jdb: invalid use of ,string struct tag, trying to unmarshal "foo" into string`},
	{`{"result":"123"}`, `jdb: invalid use of ,string struct tag, trying to unmarshal "123" into string`},
	{`{"result":123}`, `jdb: invalid use of ,string struct tag, trying to unmarshal unquoted value into string`},
}
...
type All struct {
	...
	Foo  string `jdb:"bar"`
	Foo2 string `jdb:"bar2,dummyopt"`

	IntStr     int64   `jdb:",string"`
	UintptrStr uintptr `jdb:",string"`
...
func TestEmptyString(t *testing.T) {
	type T2 struct {
		Number1 int `jdb:",string"`
		Number2 int `jdb:",string"`
	}
...
type NullTestStrings struct {
	Bool      bool              `jdb:",string"`
	Int       int               `jdb:",string"`
	Int8      int8              `jdb:",string"`
	Int16     int16             `jdb:",string"`
	Int32     int32             `jdb:",string"`
	Int64     int64             `jdb:",string"`
	Uint      uint              `jdb:",string"`
	Uint8     uint8             `jdb:",string"`
	Uint16    uint16            `jdb:",string"`
	Uint32    uint32            `jdb:",string"`
	Uint64    uint64            `jdb:",string"`
	Float32   float32           `jdb:",string"`
	Float64   float64           `jdb:",string"`
	String    string            `jdb:",string"`
	PBool     *bool             `jdb:",string"`
	Map       map[string]string `jdb:",string"`
	Slice     []string          `jdb:",string"`
	Interface interface{}       `jdb:",string"`

	PRaw    *RawMessage           `jdb:",string"`
	PTime   *time.Time            `jdb:",string"`
	PBigInt *big.Int              `jdb:",string"`
	PText   *MustNotUnmarshalText `jdb:",string"`
	PBuffer *bytes.Buffer         `jdb:",string"`
	PStruct *struct{}             `jdb:",string"`

	Raw    RawMessage           `jdb:",string"`
	Time   time.Time            `jdb:",string"`
	BigInt big.Int              `jdb:",string"`
	Text   MustNotUnmarshalText `jdb:",string"`
	Buffer bytes.Buffer         `jdb:",string"`
	Struct struct{}             `jdb:",string"`
}
...
type unexportedFields struct {
	Name string
	m    map[string]interface{} `jdb:"-"`
	m2   map[string]interface{} `jdb:"abcd"`
}
...
var invalidUnmarshalTests = []struct {
	...
	{nil, "jdb: Unmarshal(nil)"},
	{struct{}{}, "jdb: Unmarshal(non-pointer struct {})"},
	{(*int)(nil), "jdb: Unmarshal(nil *int)"},
}
...
var invalidUnmarshalTextTests = []struct {
	...
	{struct{}{}, "jdb: Unmarshal(non-pointer struct {})"},
	{(*int)(nil), "jdb: Unmarshal(nil *int)"},
	{new(net.IP), "jdb: cannot unmarshal number into Go value of type *net.IP"},
}
...
func TestInvalidStringOption(t *testing.T) {
	num := 0
	item := struct {
		T time.Time         `jdb:",string"`
		M map[string]string `jdb:",string"`
		S []string          `jdb:",string"`
		A [1]string         `jdb:",string"`
		I interface{}       `jdb:",string"`
		P *int              `jdb:",string"`
...
func TestUnmarshalEmbeddedUnexported(t *testing.T) {
	...
	tests := []struct {
		...
		ptr: new(S1),
		out: &S1{R: 2},
		err: fmt.Errorf("jdb: cannot set embedded pointer to unexported struct: json.embed1"),
	}, {
		...
		ptr: new(S5),
		out: &S5{R: 2},
		err: fmt.Errorf("jdb: cannot set embedded pointer to unexported struct: json.embed3"),
	}, {
