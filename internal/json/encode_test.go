...
type Optionals struct {
	Sr string `jdb:"sr"`
	So string `jdb:"so,omitempty"`
	Sw string `jdb:"-"`

	Ir int `jdb:"omitempty"` // actually named omitempty, not an option
	Io int `jdb:"io,omitempty"`

	Slr []string `jdb:"slr,random"`
	Slo []string `jdb:"slo,omitempty"`

	Mr map[string]interface{} `jdb:"mr"`
	Mo map[string]interface{} `jdb:",omitempty"`

	Fr float64 `jdb:"fr"`
	Fo float64 `jdb:"fo,omitempty"`

	Br bool `jdb:"br"`
	Bo bool `jdb:"bo,omitempty"`

	Ur uint `jdb:"ur"`
	Uo uint `jdb:"uo,omitempty"`

	Str struct{} `jdb:"str"`
	Sto struct{} `jdb:"sto,omitempty"`
}
